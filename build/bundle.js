...
var MultiStepForm = function (_React$Component) {
  _inherits(MultiStepForm, _React$Component);
  ...
  function MultiStepForm() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MultiStepForm.__proto__ || Object.getPrototypeOf(MultiStepForm)).call.apply(_ref, [this].concat(args))), _this), _this.checkValidity = function (event) {
      event.preventDefault();
      if (_this.props.validate()) _this.setState({ currentIndex: _this.state.currentIndex + 1 });
    }, _this.stepBack = function (event) {
      event.preventDefault();
      _this.setState({ currentIndex: _this.state.currentIndex - 1 });
    }, _this.submit = function () {
      if (_this.props.validate()) _this.props.submit();
  ...
  _createClass(MultiStepForm, [{
    ...
    value: function componentWillMount() {
      var state = {};
      this.props.children.forEach(function (i, index) {
        return state[index] = false;
      });
      this.setState(_extends({}, state, { currentIndex: 0 }));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      while (this.state[currentIndex] === false) {
        return _react2.default.createElement(
          ...
          currentIndex === this.props.children.length - 1 ? _react2.default.createElement(
            'div',
            { className: 'button-field' },
            this.props.children.length !== 1 && _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(_Button2.default, { label: 'Previous', background: theme.colors.primaryColor, onClick: this.stepBack })
            ),
            _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(_Button2.default, { label: this.props.submitText, background: theme.colors.primaryColor, onClick: this.submit })
            )
          ) : _react2.default.createElement(
            'div',
            { className: 'button-field' },
            ...
            _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(_Button2.default, { label: 'Next', background: theme.colors.primaryColor, onClick: this.checkValidity })
            )
          )
        );
      }
...
var Button = function (_React$Component) {
  ...
  _createClass(Button, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement('input', _extends({ className: 'button' }, this.props, { onSubmit: this.props.onClick, type: 'submit', value: this.props.label }));
    }
  }]);
...
// module
exports.push([module.i, ".button-field {\n  display: flex; }\n  .button-field > div {\n    flex: 1;\n    display: flex; }\n  .button-field > div > input:last-child {\n    flex: 1; }\n\n.button {\n  cursor: pointer;\n  border: none;\n  width: 120px;\n  height: 50px;\n  padding: 10px 0px;\n  border-radius: 5%;\n  text-align: center;\n  background: grey;\n  text-decoration: none;\n  -webkit-box-shadow: 2px 2px 5px 0px #9e999e;\n  -moz-box-shadow: 2px 2px 5px 0px #9e999e;\n  box-shadow: 2px 2px 5px 0px #9e999e; }\n  .button:focus {\n    outline: none; }\n", ""]);
